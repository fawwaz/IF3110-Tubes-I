...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2013 at 08:46 AM
...
INSERT INTO `data_barang` (`id_barang`, `nama`, `harga`, `stok`, `kategori`, `foto`) VALUES
(0, 'barang1', 1000, 2, '', ''),
(1, 'adada', 1000, 1, '', '');
...
(2, 'dummy1', 'dummy1', 'dummy', NULL, NULL, NULL, NULL, NULL, 'dummy@gmail.com');
